...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  UIView *rootView = RCTAppSetupDefaultRootView(bridge, @"tago", initProps);
  ...
  // }
  rootView.backgroundColor = [UIColor colorWithRed:0.00000 green:0.65490 blue:0.88235 alpha:1.0];
